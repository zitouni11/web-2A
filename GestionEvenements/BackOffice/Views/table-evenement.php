...
<div id="right-panel" class="right-panel">
                                        ...
                                        <tr>
                                          ...
                                          //execution de la requete avec la methode query la reponse sera mise dans $rep
                                            $rep= $con->query($req);
                                             if(isset($_POST["search"])) {
                                                ...
                                                $rep = $con->query("select * from evenement where id like '%$id%'");   
                                          ...
                                          ?>
                                                  <tr>
                                                      ...
                                                      <td> <a href="deleteevenement.php?rep=<?php echo $ligne['id'];?>"><button type="button" class="btn btn-outline-danger">Supprimer</button></a></td>
                                                      <td> <a href="updateevenement.php?id=<?=$ligne["id"]?>"><button type="button" class="btn btn-outline-info">modifier</button></a></td>
       ...
       <div>
            ...
            <button type="button" class="btn btn-primary btn-lg" style="margin-top:3%;margin-left:5%;border-radius: 5%;">
                <a href="ajoutevenement.php">Ajouter Evenement</a>
            </button>
            <button type="button" class="btn btn-primary btn-lg" style="margin-top:3%;margin-left:5%;border-radius: 5%;">
