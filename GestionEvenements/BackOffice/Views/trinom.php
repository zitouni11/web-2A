                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <thead>
                                    ...
                                    <tbody>
                                <?php
                                foreach($Liste as $evenementC){
                                ?>
                                <tr>
                                                    <td><?php echo $evenementC["id"];?></td>
                                                    <td><?php echo $evenementC["nom"];?></td>
                                                    <td><?php echo $evenementC["date_debut"];?></td>
                                                    <td><?php echo $evenementC["date_fin"];?></td>  
                                                    <td><?php echo $evenementC["description"];?></td>
                                                    <td><?php echo $evenementC["id_categorie"];?></td>
                                                    <td><?php echo $evenementC["id_user"];?></td>
 
                                    <td><b><a href="deleteevenement.php?id=<?php echo $evenementC['id'] ?>">Supprimer</a></b></td>
                                    <td><b><a href="updateevenement.php?id=<?php echo $evenementC['id'] ?>">Modifier</a></b></td>
                                </tr>
                                <?php } ?>
                                </tbody>
                        </table>
