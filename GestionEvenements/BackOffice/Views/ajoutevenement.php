...
<head>
    ...
    <script>
        function validateForm(e) {
            ...
            var dateDebut = document.getElementsByName('date_debut')[0].value;
            var dateFin = document.getElementsByName('date_fin')[0].value;
            var description = document.getElementsByName('description')[0].value;
            
            if (nom === "" || dateDebut === "" || dateFin === "" || description === "") {
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-area-chart"></i><a href="Gra_produit.html"> Graphiqueevenement</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-sign-in"></i><a href="ajouterevenement.php">Ajouter</a></li>
                            ...
                            <div class="card-body" >
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                      ...
                                      <hr>
                                        <form action="ajouterevenement.php" method="POST" onsubmit="return validateForm(this);">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="id_categorie" class="form-control">
                                                    ...
                                                    try {
                                                        ...
                                                        $stmt = $con->prepare("SELECT id FROM categorie");
                                                        $stmt->execute();

                                                        // Fetch the results and populate the select options
                                                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                            $id_categorie = $row['id'];
                                                            echo "<option value=\"$id_categorie\">$id_categorie</option>";
                                                        }
